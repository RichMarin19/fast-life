...
class MockHealthDataService: HealthDataAggregator {
    ...
    func buildRichHealthContext() async -> RichHealthContext {
        // Return minimal mock context for previews
        return RichHealthContext(
            currentWeight: nil,
            currentFastingStatus: nil,
            todayHydration: nil,
            todayMood: nil,
            lastNightSleep: nil,
            weightChange7d: nil,
            ...
            weightChange90d: nil,
            fastingCount90d: 0,
            avgFastDuration90d: nil,
            avgSleep90d: nil,
            avgWeightLossRate90d: nil,
            weightGoal: 170.0,
            startWeight: nil,
            totalWeightLost: nil,
            daysInJourney: nil,
            progressPercent: nil,
            estimatedDaysToGoal: nil,
            onTrackStatus: nil,
            currentFastingStreak: nil,
            longestFastingStreak: nil,
            totalFastsCompleted: nil,
            milestones: nil,
            recentHistory: nil,
            weeksWith5PlusFasts_AvgWeightLoss: nil,
            weeksWith3OrLessFasts_AvgWeightLoss: nil,
            avgWeightLoss_WellRested: nil,
            avgWeightLoss_PoorlySleep: nil,
            avgWeightLoss_HighHydration: nil,
            avgWeightLoss_LowHydration: nil,
            bestWeek_Date: nil,
            bestWeek_FastingCount: nil,
            bestWeek_WeightLoss: nil,
            worstWeek_Date: nil,
            worstWeek_FastingCount: nil,
            worstWeek_WeightChange: nil,
            avgWeightLossRate: nil,
            mostCommonFastDuration: nil,
            mostProductiveDayOfWeek: nil,
            totalWeightEntries: nil,
            totalSleepEntries: nil,
            totalHydrationEntries: nil,
